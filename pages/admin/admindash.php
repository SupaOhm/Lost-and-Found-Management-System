    ...
    <section class="feature-section py-5">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="text-muted">Manage all system activities from one place</p>
            </div>
            
            <div class="row justify-content-center">
                <!-- Claims Management Card -->
                <div class="col-lg-5 col-md-6 mb-4">
                    <a href="adminclaims.php" class="feature-card h-100 d-flex flex-column">
                        <div class="feature-icon lost mx-auto mb-3">
                            <i class="bi bi-clipboard-check"></i>
                        </div>
                        <h3 class="text-center mb-2">User Claims</h3>
                        <p class="text-center mb-0">Review, approve, or reject user claims for lost and found items</p>
                    </a>
                </div>
                
                <!-- Reports Management Card -->
                <div class="col-lg-5 col-md-6 mb-4">
                    <a href="adminreport.php" class="feature-card h-100 d-flex flex-column">
                        <div class="feature-icon found mx-auto mb-3">
                            <i class="bi bi-file-earmark-text"></i>
                        </div>
                        <h3 class="text-center mb-2">User Reports</h3>
                        <p class="text-center mb-0">View and manage all user-submitted reports and listings</p>
                    </a>
                </div>
            </div>
        </div>
